...
const UpdatePassword = () => {
    ...
    <form onSubmit={handlePasswordUpdate} className="dark:bg-gray-900 flex flex-col gap-4 py-8 px-16 sm:w-3/4">
        ...
        <div className="flex w-full gap-8 text-right items-center">
            <span className="w-1/4 font-semibold text-white">Current Password</span>
            <input
        ...
        <div className="flex w-full gap-8 text-right items-center">
            <span className="w-1/4 font-semibold text-white">New Password</span>
            <input
                className="border rounded p-1 w-3/4 placeholder:text-gray-500 text-white dark:bg-gray-800"
                type="password"
        ...
        <div className="flex w-full gap-8 text-right items-center">
            <span className="w-1/4 font-semibold text-white">Confirm New Password</span>
            <input
                className="border rounded p-1 w-3/4 placeholder:text-gray-500 text-white dark:bg-gray-800"
                type="password"
