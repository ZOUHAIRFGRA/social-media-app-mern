...
const UpdateProfile = () => {
    ...
    <form
        ...
        className="flex flex-col gap-4 py-4 px-4 sm:py-10 sm:px-24 sm:w-3/4 dark:bg-gray-900"
    >
        ...
        <div className="flex w-full gap-8 text-right items-center">
            <span className="w-1/4 font-semibold text-white">Name</span>
            <input
                className="border rounded p-1 w-3/4 placeholder:text-gray-500 text-white dark:bg-gray-800"
                type="text"
                placeholder="Name"
                value={name}
        ...
        <div className="flex w-full gap-8 text-right items-center">
            <span className="w-1/4 font-semibold text-white">Username</span>
            <input
                className="border rounded p-1 w-3/4 placeholder:text-gray-500 text-white dark:bg-gray-800"
                type="text"
        ...
        <div className="flex w-full gap-8 text-right items-center">
            <span className="w-1/4 font-semibold text-white">Website</span>
            <input
                className="border rounded p-1 w-3/4 placeholder:text-gray-500 text-white dark:bg-gray-800"
                type="url"
                placeholder="Website"
        ...
        <div className="flex w-full gap-8 text-right items-start">
            <span className="w-1/4 font-semibold text-white">Bio</span>
            <textarea
                className="border rounded outline-none resize-none p-1 w-3/4 placeholder:text-gray-500 text-white dark:bg-gray-800"
                name="bio"
                placeholder="Bio"
                rows="3"
                value={bio}
        ...
        <div className="flex w-full gap-8 text-right items-center">
            <span className="w-1/4 font-semibold text-white">Email</span>
            <input
                className="border rounded p-1 w-3/4 placeholder:text-gray-500 text-white dark:bg-gray-800"
                type="email"
                placeholder="Email"
