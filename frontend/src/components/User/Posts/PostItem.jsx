...
const PostItem = ({
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xl">
        <div className="flex sm:flex-row flex-col max-w-7xl">
          ...
          <div className="flex flex-col justify-between border w-full max-w-xl rounded bg-gray-900 text-white">
            {/* id with menu icon */}
    ...
    <div className="flex flex-col items-center w-80 bg-gray-900 text-white">
        {postedBy._id === user._id && (
            <button
                onClick={handleDeletePost}
                className="text-red-600 font-medium border-b py-2.5 w-full hover:bg-red-800 hover:text-white"
            >
                Delete
            </button>
        )}
        <button
            ...
            className="py-2.5 w-full hover:bg-gray-800 hover:text-white"
        >
            Cancel
        </button>
    </div>
