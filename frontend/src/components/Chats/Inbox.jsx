...
const Inbox = () => {
  ...
  return (
    <>
      <MetaData title="Chats" />

      <div className="mt-14 sm:mt-[4.7rem] pb-4 rounded h-[90vh] xl:w-2/3 mx-auto sm:pr-14 sm:pl-8 ">
        <div className="flex border h-full rounded w-full bg-white dark:bg-gray-800">
          {/* sidebar */}
          ...
          {!userId ? (
            <div className="flex flex-col items-center justify-center w-full sm:w-4/6 gap-2">
              ...
              <h2 className="text-2xl font-thin text-white">Your Messages</h2>
            ...
            <div className="flex flex-col justify-between w-full sm:w-4/6">
              ...
              >
                ...
                <input
                  className="flex-1 outline-none text-sm bg-transparent text-black dark:text-white placeholder-gray-400 dark:placeholder-gray-600"
                  type="text"
                  placeholder="Message..."
                  value={message}
