...
const PostItem = ({
  ...
  return (
    <div className="flex flex-col border rounded bg-gray-800 relative">
      <div className="flex justify-between px-3 py-2.5 border-b items-center">
        ...
        <span className="cursor-pointer">{<DehazeIcon/>}</span>
      </div>
      ...
      <div className="flex flex-col px-4 space-y-1 border-b pb-2 mt-2">
        ...
        <div className="flex flex-auto items-center space-x-1">
          ...
          <span className="text-sm text-white">{caption}</span>
        </div>
        ...
        {viewComment && (
          <ScrollToBottom className="w-full h-52 overflow-y-auto py-1">
            {allComments.map((c) => (
              <div className="flex items-start mb-2 space-x-2 text-white" key={c._id}>
                <img
                  draggable="false"
      ...
      >
        ...
        <input
          className="flex-auto text-sm outline-none border-none bg-transparent text-white"
          type="text"
          value={comment}
          ref={commentInput}
          required
